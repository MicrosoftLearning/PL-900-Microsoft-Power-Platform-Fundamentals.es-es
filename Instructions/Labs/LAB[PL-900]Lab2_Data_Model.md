...
2.  En la pantalla principal de Power Pages, con el panel de navegación de la izquierda, seleccione **Tablas**.
3.  En **Tablas**, seleccione **Introducción a Copilot**.
4.  En la pantalla **Describir las tablas que desea que construya Copilot**, introduzca: “*Crear una tabla para administrar eventos. La tabla debe identificar el nombre del evento, los datos del evento, la ubicación, el número máximo de asistentes y los detalles del evento.”*
5.  Junto al botón **Generar**, seleccione **Configuración de tabla** y configúrela como se indica a continuación:
...
7.  En el campo **Qué desea hacer a continuación**, introduzca: “*Agregar una columna de opción denominada “Tipo de evento.*
8.  Agregue otra columna escribiendo el texto siguiente: ”*Agregar una columna de opción denominada Registro requerido*."
...
9.  En la **Barra de comandos** de la parte superior, seleccione **+ Tabla existente.**
10.  En el campo **Buscar**, introduzca **Contacto** y seleccione **Agregar seleccionado**.
...
11.  En el campo **Qué desea hacer a continuación**, introduzca: “*Agregar una nueva tabla denominada Sesión de eventos.”*
...
12.  Si es necesario, en el campo **Qué desea hacer a continuación**, introduzca: “*Eliminar la tabla de Ponente de eventos.”*
13.  En Copilot, escriba el texto siguiente: “*Agregar una nueva columna de texto a la tabla Sesión de eventos denominada Descripción de la sesión.”*
...
14.  En Copilot, escriba el texto siguiente: “*Agregar una nueva tabla denominada Registros de sesión.”*
...
15.  En Copilot, escriba el texto siguiente: “*Quitar la tabla Participante.”*
...
16. Si es necesario, en Copilot, escriba el texto siguiente: “Quite la columna Nombre del participante de la tabla Registro de sesión.”

17. Si ahora tiene un campo Columna principal, escriba el texto siguiente: *Cambie el nombre de la Columna principal a Nombre de registro.*

18.  En Copilot, escriba el texto siguiente: “*Agregar una columna de texto a la tabla de registro de sesión denominada Instrucciones especiales.”*
...
18.  En la barra Comandos, seleccione **Crear relaciones**.
19.  Configure la relación como sigue:
- **Tipo de relación:** Uno a varios
- **Uno:** Contacto
- **Varios:** Sesión de eventos
- **Nombre para mostrar:** Orador
20.  Selecciona **Listo.**
...
21.  En la barra Comandos, seleccione **Crear relaciones**.
22.  Configure la relación como sigue:
- **Tipo de relación:** Uno a varios
- **Uno:** Contacto
- **Varios:** Registro de sesión
- **Nombre para mostrar:** Participante
...
24.  En la barra Comandos, seleccione **Crear relaciones**.
25.  Configure la relación como sigue:
- **Tipo de relación:** Uno a varios
- **Uno:** Evento
- **Varios:** Sesión de eventos
- **Nombre para mostrar:** Evento
...
27.  En la barra Comandos, seleccione **Crear relaciones**.
28.  Configure la relación como sigue:
- **Tipo de relación:** Uno a varios
- **Uno:** Sesión de eventos
- **Varios:** Registros de sesión
- **Nombre para mostrar:** Sesión de eventos
...
1.  Si es necesario, abra un explorador web y vaya al portal de [Power Apps](https://make.powerapps.com/) Maker Portal e Inicie sesión con las credenciales de la cuenta Microsoft.
2.  En el panel de navegación de la izquierda, selecciona **Tablas**.
3.  En el campo **Buscar**, escriba **Evento**.
4.  Abra la tabla **Evento**.
5.  Bajo el título **Esquema**, seleccione **Columnas**.
6.  Busque y abra la columna **Tipo de evento**.
7.  Reemplace las etiquetas por lo siguiente:
    - Conferencia
    - Feria comercial
    - Seminario web
    - Almuerzo y aprendizaje
    - Launch
8.  Establezca **Opción predeterminada** en **Ninguna**.

![Recorte de pantalla de las opciones actualizadas del tipo de evento. ](media/3fb723bad1c0fced1e3705124a2d4594.png)

9.  Selecciona el botón **Guardar**. (*Si la columna no se guarda la primera vez, inténtelo de nuevo.*)
...
10.  Utilizando la navegación de la izquierda, seleccione **Tablas** para salir de la tabla **Evento**.
11.  En el campo **Buscar**, escriba **Evento**.
12.  Abra la tabla **Sesión de eventos**.
13.  Bajo el título **Esquema**, seleccione **Columnas**.
14.  En la barra de comandos, seleccione el botón **Nueva columna**.
15.  Configure la nueva columna de la siguiente manera:
    - **Nombre para mostrar**: Total de registros
...
16.  Seleccione **Guardar y editar**.
...
17.  Configure la columna de acumulación de la siguiente manera:
...
2.  En **Tablas**, seleccione **Introducción a Copilot**.
3.  En la pantalla **Describir las tablas que desea que construya Copilot**, introduzca: “*Crear una tabla para restaurar el equipo. La tabla debe incluir el nombre del equipo, la fecha de vencimiento y el número de elemento.”*
4.  Junto al botón **Generar**, seleccione **Configuración de tabla** y configúrela como se indica a continuación:
- **Opciones de tabla:** Una tabla
- **NO** incluya relaciones.
...
Ahora que hemos creado la tabla, vamos a añadirle algunas columnas adicionales. Comenzaremos agregando una columna de tipo de evento. Además, los contactos asistirán a nuestros eventos. Queremos agregar la tabla Contacto existente al modelo de datos y asociarla a registros de eventos más adelante.
6.  En el campo **Qué desea hacer a continuación**, introduzca: *“Cambie el nombre de la tabla a Equipo.”*
7.  En el campo **Qué desea hacer a continuación**, introduzca: *“Agregar una columna de elección denominada Tipo de equipo.”*
8.  Agregue otra columna escribiendo el texto siguiente: *”Agregar una columna de texto denominada Categoría.”*
9.  Agregue otra columna escribiendo el texto siguiente: *”Agregar una columna de texto denominada Estado.”*
...
10. Si la tabla incluye columnas adicionales, quite esas columnas escribiendo *“Eliminar la columna [nombre de columna”].*
11. Una vez que la tabla coincida con la imagen, seleccione **Guardar y salir**.
...
2.  En el panel de navegación de la izquierda, selecciona **Tablas**.
3.  En el campo **Buscar**, escriba **Equipo**.
4.  Abra la tabla **Equipo**.
5.  Bajo el título **Esquema**, seleccione **Columnas**.
6.  Localice y abra la columna **Tipo de equipo**.
7.  Si es necesario, reemplace las etiquetas por lo siguiente:
- Electrónica
- Mobiliario
- Herramientas
- Accesorios
