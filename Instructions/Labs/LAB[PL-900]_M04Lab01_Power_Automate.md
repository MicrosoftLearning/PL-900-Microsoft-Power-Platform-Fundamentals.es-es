...
## <a name="task-1-create-flow"></a>Tarea \#1: Crear flujo
...
2.  Haga clic en **Nuevo** y seleccione **Automatización**, **Flujo de nube** y, después, **Automatizado**. Se abrirá el editor de flujo de Power Automate en una nueva ventana.

3. En **Elegir el desencadenador del flujo**, busque **Microsoft Dataverse**.

4. Seleccione el desencadenador **Cuando se agrega, modifica o elimina una fila** y, luego, haga clic en **Crear**.
...
9. Busque *correo*, seleccione el conector de **Office 365 Outlook** y la acción **Enviar un correo electrónico (V2)** .
...
## <a name="task-2-validate-and-test-the-flow"></a>Tarea \#2: Validar y probar el flujo
...
# <a name="exercise-2-create-security-sweep-flow"></a>Ejercicio 2: Cree un flujo de barrido de seguridad
...
## <a name="task-1-create-flow-to-retrieve-records"></a>Tarea n.° 1: Crear un flujo para recuperar registros
...
2. Haga clic en **Nuevo** y seleccione **Automatización**, **Flujo de nube** y, después, **Programado**. Se abrirá el editor de flujo de Power Automate en una nueva ventana.

3. Establezca el flujo para que se repita cada **15** minutos.

4. Haga clic en **Crear**.

5. Haga clic en **New Step** (Nuevo paso). Busque *Current* y seleccione el conector de **Microsoft Dataverse**. Seleccione la acción **Filas de lista**.
...
6.  Haga clic en **New Step** (Nuevo paso). Busque *Aplicar*, Seleccione la acción **Aplicar a cada una** 
...
10.  Enviar notificaciones por correo electrónico
     ...
     * Haga clic en **Agregar una acción** dentro de Aplicar para cada bucle. Agregue la acción **Enviar un correo electrónico (V2)** desde la conexión de **Office 365 Outlook**.
...
13.  Escriba lo siguiente en el campo **Cuerpo**. **Nombre** es un contenido dinámico de la etapa **Obtener edificio**. Es posible que tenga que desplazarse hasta la parte inferior de la lista.
...
## <a name="task-2-validate-and-test-the-flow"></a>Tarea n.°2: Validar y probar el flujo
