...
2.  En el panel de navegación de la izquierda, selecciona **Soluciones.**
3.  Abra la solución **Administración de eventos** que creó anteriormente.
4.  En la **Barra de comandos** seleccione **Nuevo** \> **Aplicación** \> **Aplicación basada en modelos**.
5.  Seleccione la sección **Crear**.
    -   **Nombre**: Administración de eventos de Contoso
    -   **Descripción:** Se usa para administrar eventos y sesiones de eventos.
6.  Seleccione el botón **Crear****.**
7.  Seleccione el botón **Agregar página**, seleccione **Tabla Dataverse.**
8.  Selecciona las tablas siguientes:
    -   Contacto
    -   Evento
    -   Sesión de evento
    -   Registro de sesión
9.  Asegúrese de que Mostrar en navegación está seleccionado.
...
2.  En la parte derecha de la aplicación, implemente el panel **Propiedades**.
3.  Cambie el **Título** de **Nuevo Grupo** a **Personas.**

    ![Recorte de pantalla que muestra cómo cambiar un nombre de grupo. ](media/82b6d0cdc4fdbaf4a9eaf2d1f82e972f.png)

4.  Seleccione la **Ellipsis** en el grupo **Personas**.
5.  Elija **Nuevo grupo**.
6.  En el panel **Propiedades**, cambie el nombre del grupo de **Nuevo grupo** a **Eventos.**
7.  Pase el ratón por encima de **Vista de registros de sesión** a la izquierda, seleccione **elipsis** y seleccione **Desplazar hacia abajo** para mover **Registros de sesión** al grupo **Eventos**.
8.  Pase el ratón por encima de la vista **Sesiones de evento** de la izquierda, seleccione la **elipsis** y seleccione **Desplazar hacia abajo** para mover **Sesiones de evento** al grupo **Eventos**.
9.  Pase el ratón por encima de **Vista de eventos** a la izquierda, seleccione la **elipsis** y seleccione **Desplazar hacia abajo** para mover **Eventos** al grupo **Eventos**.
...
2.  En la parte izquierda de la pantalla, bajo el grupo **Personas**, pase el ratón sobre **Formulario de contactos** y seleccione **Editar.**

    Si se le pide que guarde los cambios, seleccione **Guardar y continuar.**

3.  En **Columnas de tabla** a la izquierda, seleccione **Nueva columna de tabla**.
4.  Configure la columna de la tabla de la siguiente manera:
    -   **Nombre para mostrar**: Tipo de contacto
    -   **Tipo de datos:** Opción
    -   **Sincronización con la elección global:** No
5.  Establezca la **Etiqueta** de la primera opción en **Ponente.**
6.  Seleccione **+ Nueva opción** y establezca la etiqueta en **Participante.**
7.  Seleccione **+ Nueva opción** y establezca la etiqueta en **Personal de soporte técnico.**
...
9.  Con el ratón, seleccione el texto **Nuevo contacto** para seleccionar la cabecera del formulario. *(Debe aparecer un rectángulo morado alrededor de la cabecera)*
10. En **Columnas de tabla**, en el campo **Buscar**, introduzca **Contacto**.
11. Seleccione la columna de la tabla **Tipo de contacto** que acaba de crear.
12. El **Tipo de contacto** debería aparecer ahora en el **Título**.

![Recorte de pantalla que muestra el campo tipo de contacto en un formulario.](media/4debe7a09e460f79c1cb05a6824dad66.png)

13. En la **Barra de comandos** del formulario, seleccione el botón **Guardar y publicar**.
14. Seleccione el botón **Flecha atrás** para volver al diseñador de aplicaciones basadas en modelos.
15. En **Navegación** a la izquierda, sitúe el cursor sobre **Vista de contactos** y seleccione el icono **Editar**. (Si se le pide que guarde, seleccione **Guardar y continuar.**)
16. Seleccione **+ Ver columna**.
17. Busque y agregue la columna **Tipo de contacto** a la vista.
18. Seleccione el botón **Guardar y publicar**.
19. Seleccione el botón **Flecha atrás** para volver al diseñador de aplicaciones basado en modelos.

A continuación, vamos a realizar los cambios necesarios en el resto de formularios.

20.  En **Navegación**, seleccione **Vista de eventos**.
...
21.  Pase el ratón por encima de la vista **Eventos** y seleccione el botón **Editar**.

Si se le pide **Guardar** los cambios, seleccione **Guardar y continuar**.

22.  En la **Vista**, seleccione la flecha situada junto a **Detalles de evento 1** y, en el menú que aparece, seleccione **Eliminar**.
...
23.  Seleccione el botón **Guardar y publicar**.
24.  Seleccione el botón **Flecha atrás** para volver al diseñador de aplicaciones.
25.  En **Navegación**, sitúe el cursor sobre **Formulario de ** **eventos** y seleccione **Editar**.

Si se le pide guardar los cambios, seleccione **Guardar y continuar**.

26.  Seleccione el campo **Detalles del evento 1** y pulse la tecla **Eliminar** del teclado.
...
27.  Selecciona el botón **Guardar y publicar**.
28.  Seleccione el botón **Flecha atrás** para volver al diseñador de aplicaciones.
...
2.  Seleccione el botón **Atrás** para volver a la solución **Administración de eventos**.
3.  Seleccione la flecha **Volver a soluciones** para volver al portal principal **Power Apps** Maker Portal.
4.  Seleccione la flecha **Atrás** para volver a la pantalla principal de **PowerApps**.
...
2.  Cambie las aplicaciones que se muestran en **Mis aplicaciones** a **Todas**.
3.  Pase el ratón por encima de la aplicación **Administración de eventos** que acaba de crear y seleccione el icono **Reproducir**.
4.  Con el panel de navegación de la izquierda, seleccione **Contactos**.
5.  En la barra de **Comandos**, seleccione el botón **+Nuevo**.
6.  En la pantalla **Nuevo contacto**, configure de la siguiente manera:
    -   **Nombre:** Suzanne
    -   **Apellidos:** Diaz.
    -   **Puesto:** Ingeniero
7.  En el encabezado del formulario, seleccione la flecha hacia abajo situada junto a **Tipo de contacto**.
8.  Establezca el **Tipo de contacto** en **Ponente**.
...
9.  Seleccione el botón **Guardar** para guardar el contacto y déjelo abierto.
10. Seleccione el botón **+ Nuevo**.
11. En la pantalla **Nuevo contacto**, configure de la siguiente manera:
    -   **Nombre:** Edgar
    -   **Apellidos:** Swenson
    -   **Puesto:** Arquitecto
    -   **Correo electrónico:** Introduzca su dirección de correo electrónico (Asegúrese de agregar **su** dirección de correo electrónico.)
12. En el encabezado del formulario, seleccione la flecha hacia abajo situada junto a **Tipo de contacto**.
13. Establezca el **Tipo de contacto** en **Participante**.
14. Seleccione el botón **Guardar y cerrar**.

A continuación, vamos a agregar un nuevo evento.

15.  Con el panel de navegación de la izquierda, seleccione **Eventos**.
16.  En la barra de comandos, selecciona el botón **+ Nuevo**.
17.  En la pantalla **Nuevo evento**, use la siguiente configuración:
...
19.  Con el panel de navegación de la izquierda, seleccione **Sesiones de eventos**.
20.  Seleccione el botón **+ Nuevo**.
21.  Configure la **Sesión de eventos** de la siguiente manera:
...
22.  Seleccione el botón **Guardar y cerrar**.

Por último, vamos a crear un **Registro de sesión**.

23.  Con el panel de navegación de la izquierda, seleccione **Registros de sesión.**
24.  En la **Barra de comandos**, seleccione **+ Nuevo**.
25.  Complete el registro de sesión de la manera siguiente:
- **Nombre de registro:** E, Registro de Swenson.
- **Propietario:** Déjelo tal cual
- **Fecha del registro:** Fecha de hoy
- **Instrucciones especiales:** Sin gluten
- **Participante:** Edgar Swenson
- **Sesión de eventos:** IA responsable

![Captura de pantalla del formulario de registro de sesión completado.  ](media/Session-registration-form.png)

26.  Seleccione el botón **Guardar y cerrar**.
